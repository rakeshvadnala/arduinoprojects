...
void setup() 
{
  ...
  pinMode(PIR_sensor, INPUT);
   lcd.print("    Automatic    ");
   Serial.print("    Automatic    /n");
  lcd.setCursor(0,1); 
  lcd.print("   Door Opener   ");
   Serial.print("   Door Opener   /n");
  delay(1000);
  lcd.clear();
...
void loop() 
{
  if(digitalRead(PIR_sensor))
  {
    ...
    Serial.print("Movement Detected/n");
    lcd.setCursor(0, 1);
    lcd.print("    Gate Opened    ");
    Serial.print("    Gate Opened    /n");
